                    ...
                    <form method="POST" action="{{ route('/estoque/abrirEntrada') }}">
                      {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input name="quantidade" id="quantidade" type="number" pattern="^[-+]?[0-9]*" class="form-control" value="{{$estoque_item->quantidade}}"> {{ $errors->first('quantidade')}}</input>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input name="quantidade_danificados" id="quantidade_danificados" type="number" pattern="^[-+]?[0-9]*" class="form-control" value="{{$estoque_item->quantidade_danificados}}"> {{ $errors->first('quantidade_danificados')}}</input>
