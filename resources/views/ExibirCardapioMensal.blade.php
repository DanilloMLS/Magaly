                ...
                {{ csrf_field() }}
                  ...
                  <div id="Cardapio">
                    ...
                    @endphp
                      ...
                      @endphp
                      <center><strong><h4 class="cabecalho_semana_cardapio">Semana {{$semana_x}}</h4><strong></center>
                                ...
                                @php for($dia_x = 1; $dia_x <= 5; $dia_x++){ @endphp
                                  ...
                                  @if(!empty($cardapio_diario))
                                    ...
                                    <td class="cardapio_semana_20-justify" data-title="Segunda" style="color:green">               
                                      <a class="green-link link" href="{{ route("/refeicao/exibirItensRefeicao", ['id' => $cardapio_diario_refeicoes->refeicao_id]) }}">
                                        {{$refeicao->nome}}
                                      </a>

                                    </td>
                                    @else
                                    <td class="cardapio_semana_20" data-title="dia_x">. . .</td>
                                  @endif
                                @php
                                }
                                @endphp
