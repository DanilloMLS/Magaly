                    ...
                    <form method="POST" action="{{ route('/item/cadastrar') }}">
                      {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input name="n_lote" id="descricao" type="text" class="form-control" required value= {{ old('descricao')}}> {{ $errors->first('descricao')}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select class="form-control" id="contratos" name="contrato_id" required="required">
                            ...
                            @else
                            <div class="col-md-6">
                              <select class="form-control" id="contratos" name="contrato_id" >
      								              <option value="0">Não há contratos cadastrados</option>
                              </select>
                            </div>
                            @endif
                         </div>
