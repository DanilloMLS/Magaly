...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Editar Ordem de Fornecimento') }}</div>
                    ...
                    <form method="POST" action="{{ route('/ordemfornecimento/salvarOrdem') }}">
                      {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input name="data" id="data" type="date" class="form-control{{ $errors->has('data') ? ' is-invalid' : '' }}" value="{{old('data', $ordem_fornecimento->data)}}">
                              @if ($errors->has('data'))
