                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('/itemRefeicao/salvar') }}">
                      ...
                      {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            <label for="gramatura" class="col-md-4 col-form-label text-md-right">{{ __('Descrição ') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <input name="quantidade" id="quantidade" type="text"  class="form-control" value="{{ $item_refeicao->quantidade}}" required value= {{ old('quantidade')}}> {{ $errors->first('quantidade')}}
                            </div>
                        </div>
