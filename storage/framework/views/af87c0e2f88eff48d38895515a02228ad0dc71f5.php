                  ...
                  <div class="panel-body">
                      ...
                      <input type="text" id="termo" onkeyup="buscar()" placeholder="Busca">
                        ...
                        <div id="tabela" class="table-responsive">
                          <h5 class="card-title">
                            Exibindo <?php echo e($fornecedores->count()); ?> fornecedores de <?php echo e($fornecedores->total()); ?> 
                            (<?php echo e($fornecedores->firstItem()); ?> a <?php echo e($fornecedores->lastItem()); ?>)
                          </h5>
                            ...
                            <tbody>
                              <?php $__currentLoopData = $fornecedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fornecedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                      <a class="btn btn-primary" href="<?php echo e(route ("/fornecedor/editar", ['id' => $fornecedor->id])); ?>">
